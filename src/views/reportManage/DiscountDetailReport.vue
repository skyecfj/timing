...
<script>
  ...
  //查询form配置
  import pageUtil from '../../utils/restaurant/report/discountAbnormalDetailreport'
  //表格
  import tableOrigin from '../restaurant/BOHDataMg/originalTable'
    ...
    methods: {
      ...
      doExport(){
        ...
        apiStore.exportDiscountDetailReport(searchObj,function(res){
            if(res.code === 200){
      ...
      getData(){
        ...
        apiStore.getDiscountDetailReport(param,function(result){
          if(result.code === 200){
