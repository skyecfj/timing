    ...
    export default {
        ...
        data() {
            return {
                ...
                tableHead: [
                    ...
                    {
                        label:'BOH报送值(vouchers超收)',
                        prop:'vouchers'
                    },
                    {
                        label:'BOH报送值(非餐券超收)',
                        prop:'noCouponsOvercharge'
                    },
                    {
                        label:'折扣',
                        prop:'discount'
        ...
        methods: {
            ...
            getData(pageIndex) {
                ...
                let that = this;
                api.getRevenue(this.getParam(),function(res){
                    if(res.code === 200){
            ...
            reset() {
                this.storeName = '';
                this.$refs.revenueReport.reset();
            },
            download(){
                let that = this;
                api.downloadRevenue(this.getParam(),'application/vnd.ms-excel',function(res,header){
