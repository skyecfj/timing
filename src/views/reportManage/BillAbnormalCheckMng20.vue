...
<script>
  ...
  //查询form配置
  import pageUtil from '../../utils/restaurant/report/billAbnormalCheckMng20'
  //表格
  import tableOrigin from '../restaurant/BOHDataMg/originalTable'
    ...
    methods: {
      ...
      doExport(){
        ...
        //     return false;
        // }
        apiStore.exportBillAbnormalCheckDetailReport20(searchObj,'application/vnd.ms-excel',function(res){
            if(res.code){
              ...
              link.href = res;
              link.download = '账单异常检查报表(20%).xlsx'
      ...
      getData(){
        ...
        apiStore.getBillAbnormalCheckDetailReport20(param,function(result){
          if(result.code === 200){
