    ...
    export default {
            ...
            return {
                ...
                tableHead: [
...

                    {
                        ...
                        fixed:true,
                        formatter:(row)=>{
                            switch(row.resonCategory){
                                case '1': return '餐厅管理组未及时存行';
                                case '2': return '餐厅存行有差异';
                                case '3': return '银行问题滞后';
                                case '4': return '保险柜故障';
                                case '5': return '其他';
                                default:return;
                            }
        ...
        methods: {
            ...
            getData(pageIndex) {
                ...
                let that = this;
                api.getNotSaveButDo(this.getParam(),function(res){
                    if(res.code === 200){
        ...
        mounted(){
            ...
            this.dynamicHeight = parseInt(document.body.clientHeight - document.getElementsByClassName('notSaveButDoReportTable')[0].getElementsByClassName('search-content')[0].clientHeight - 250)
        }
    }
</script>
