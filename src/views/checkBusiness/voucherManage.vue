        ...
        <div class="searchContent">
            <div class="selectContent">
                ...
                <el-select size="small" v-model="businessType" placeholder="请选择" filterable @change="changeBusinessType">
                    <el-option v-for="item in businessTypeOptions" :key="item.id" :label="item.instruction"
                               :value="item.code">
                    </el-option>
                </el-select>
            </div>
            ...
            <div class="selectContent">
                ...
                <el-select size="small" v-model="accountMode" placeholder="请选择" filterable>
                    <el-option v-for="item in accountModeOption" :key="item.value" :label="item.label"
                               :value="item.value">
                    </el-option>
                </el-select>
            </div>
            ...
            <div class="selectContent">
                    <div class="selectTitle">JDE单据号</div>
                    <el-input size="small" v-model.trim="jdeInvoiceNumber" placeholder="请输入" clearable></el-input>
            </div>
            <div class="selectContent">
                <div class="selectTitle">JDE批号</div>
                <el-input class="" v-model.trim="jdeBatchNo" placeholder="请输入" clearable>
                </el-input>
            </div>
            <div class="selectContent">
            ...
            <div class="selectContent" key="auditStatusContent" >
                <div class="selectTitle">审核状态</div>
                <el-select size="small" v-model="auditingFlag" placeholder="请选择">
                    <el-option label="请选择" value=""></el-option>
            ...
            <div class="selectContent">
                <div class="selectTitle">制单人</div>
                <el-input class="" v-model.trim="createUser" placeholder="请输入" clearable>
                </el-input>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            canEdit(rowObj){
                if((rowObj.isManualRecording && rowObj.businessType == 'STORE' && rowObj.jdeFlag == 0) ||
                   (rowObj.isManualRecording && rowObj.businessType != 'STORE' && rowObj.jdeFlag != 1 && rowObj.jdeFlag != 2 )){
                    return true
                }
            },
            ...
            getSearchCondition() {
                ...
                api.getDictionaryByNumber('ACCOUNTSET', function (res) {
                    if (res.code == 200) {
                        that.accountModeOption = []
                        that.accountModeOption.push({
                            value: '',
                            label: '请选择'
                        })
                        res.data.forEach(function (item, index) {
                            that.accountModeOption.push(
                                {
                                    value: item.dictionaryEntryName,
            ...
            changeInstruction() {
                if (this.businessType == 'STORE' && this.code == 'STORE_0000' && !this.filterJdeFlage('待审核')) {
                    this.jdeFlagOptions.splice(1, 0, {
                        value: '11',
                        label: '待审核'
                    })
                } else {
                    if (this.filterJdeFlage('待审核')) {
                        this.jdeFlagOptions.splice(1, 1)
                        this.jdeFlag = ''
                    }
                }
            },
            filterJdeFlage(val) {
                for (let item of this.jdeFlagOptions) {
                    if (item.label == val) {
                        return true
                    }
                }
            ...
            getVoucherList() {
                ...
                var param = [
                    ...
                    {
                        name: 'accountMode',
                        value: this.accountMode
                    },
                    {
                        name: 'jdeInvoiceNumber',
                        value: this.jdeInvoiceNumber
                    },
                    {
                        name: 'jdeBatchNo',
                        value: this.jdeBatchNo
                    },
                    {
                        name: 'startTime',
                        value: this.createTime ? this.createTime[0] : ''
                    },
                    {
                        name: 'endTime',
                        value: this.createTime ? this.createTime[1] : ''
                    },
                    {
                        name: 'jdeFlag',
