  ...
  <div class="mainContent">
    <div class="searchContent">
      ...
      <div class="selectContent">
        ...
        <el-select size="small" v-model="activityType">
          <el-option value="" label="请选择"></el-option>
          <el-option v-for="item in activityTypeSelect" :key="item.activityTypeId" :label="item.activityTypeName" :value="item.activityTypeName">
          </el-option>
        </el-select>
      </div>
      <div class="selectContent">
    ...
    <div class="dataContent">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="guaranteedWarnThreshold" label="保证金额预警阈值" width="120"></el-table-column>
        <el-table-column prop="arAmount" label="预警时AR"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    exportReport () {
      let that = this
      let pathParams = this.common.formatPathParam({
      ...
      apidr.exportAmountWarning(pathParams, 'application/vnd.ms-excel', function(res){
        if (res.code) {
          ...
          link.download = '活动预警报告-金额预警.xlsx'
    ...
    getAmountWarning () {
      ...
      apidr.getAmountWarning(this.common.joinSearchParam(pathParams), function(res){
        that.tableData = []
     	that.totalRecords = 0
        if (res.code === 200) {
