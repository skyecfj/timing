                ...
                <el-col :span="10">
                    <el-card class="box-card">
                        ...
                        <el-table :data="dynamicDataLeft" max-height="800"
                                  highlight-current-row :row-style="styleFn">
        ...
        methods: {
            ...
            getAllActivityById () {
                ...
                if (this.dynamicDataRight && this.dynamicDataRight.length > 0) {
                    this.dynamicDataRight.forEach(function (item, index) {
                        that.selectedActivities.push(item.id);
                    })
                }
            },
