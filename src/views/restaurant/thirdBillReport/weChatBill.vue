<template>
  <div class="mainContent">
    <div class="searchContent">
      ...
      <div class="selectContent">
        <div class="selectTitle">交易渠道</div>
        <el-select size="small" v-model="transChannel">
        	<el-option value="" label="请选择"></el-option>
          <el-option v-for="item in transChannelOptions" :key="item.value" :label="item.name" :value="item.value">
          </el-option>
        </el-select>
      </div>
      <div class="selectContent">
    ...
    <div class="dataContent">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="posNo" label="终端号"></el-table-column>
        ...
        <el-table-column prop="wechatTransNo" label="微信交易号" width="260"></el-table-column>
        <el-table-column prop="wechatAccount" label="客户微信账户" width="220"></el-table-column>
        ...
        <el-table-column prop="cftAmount" label="财付通开票金额" width="110"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    exportReport () {
      let that = this
      apidr.exportWechatDetail(this.wechatSearchData, 'application/vnd.ms-excel', function(res){
        if (res.code) {
    ...
    getWechatReport () {
      ...
      apidr.getWechatReport(this.common.joinSearchParam(pathParams), function(res){
      	that.tableData = []
      	that.totalRecords = 0
        if (res.code === 200) {
